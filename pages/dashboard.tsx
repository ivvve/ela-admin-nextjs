              ...
              <div className="col-lg-4">
                <div className="card-body">
                  ...
                  <div className="progress-box progress-2">
                    ...
                    <div className="progress mb-2" style={{ height: '5px' }}>
                      <div className="progress-bar bg-flat-color-3" role="progressbar" style={{ width: '60%' }}
                  ...
                  <div className="progress-box progress-2">
                    ...
                    <div className="progress mb-2" style={{ height: '5px' }}>
                      <div className="progress-bar bg-flat-color-4" role="progressbar" style={{ width: '90%' }}
                    ...
                    <div className="tdl-content">
                      <ul>
                        <li>
                          <label>
                            <input type="checkbox"/>
                            <i className="check-box"/><span>Conveniently fabricate interactive technology for ....</span>
                        ...
                        <li>
                          <label>
                            <input type="checkbox"/>
                            <i className="check-box"/><span>Creating component page</span>
                            <a href='#' className="fa fa-times"></a>
                            <a href='#' className="fa fa-pencil"></a>
                            <a href='#' className="fa fa-check"></a>
                          </label>
                        ...
                        <li>
                          <label>
                            ...
                            <i className="check-box"/><span>Follow back those who follow you</span>
                            <a href='#' className="fa fa-times"></a>
                            <a href='#' className="fa fa-pencil"></a>
                            <a href='#' className="fa fa-check"></a>
                          </label>
                        ...
                        <li>
                          <label>
                            <input type="checkbox" checked/>
                            <i className="check-box"></i><span>Design One page theme</span>
                            <a href='#' className="fa fa-times"></a>
                            <a href='#' className="fa fa-pencil"></a>
                            <a href='#' className="fa fa-check"></a>
                          </label>
                      ...
                      <div className="msg-received msg-container">
                        ...
                        <div className="msg-box">
                          <div className="inner-box">
                            ...
                            <div className="meg">
                              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis sunt placeat velit
                              ad reiciendis ipsam
                            </div>
                          </div>
                        </div>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-success save-event waves-effect waves-light">Create event
              </button>
