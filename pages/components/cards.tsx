    ...
    <Layout title='Cards'>
      ...
      <div className="row">
            ...
            <div className="card-body">
              <div className="mx-auto d-block">
                ...
                <div className="location text-sm-center">
                  <i className="fa fa-map-marker"/> California, United States
                </div>
              </div>
              <hr/>
              <div className="card-text text-sm-center">
                <a href="#"><i className="fa fa-facebook pr-1"/></a>
                <a href="#"><i className="fa fa-twitter pr-1"/></a>
                <a href="#"><i className="fa fa-linkedin pr-1"/></a>
                <a href="#"><i className="fa fa-pinterest pr-1"/></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-header">
              <i className="fa fa-user"/><strong className="card-title pl-2">Profile Card</strong>
            </div>
            <div className="card-body">
              <div className="mx-auto d-block">
                <img className="rounded-circle mx-auto d-block" src="/images/admin.jpg" alt="Card image cap"/>
            ...
            <section className="card">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item">
                  <a href="#">
                    <i className="fa fa-envelope-o"/> Mail Inbox <span className="badge badge-primary pull-right">10</span>
                  </a>
                </li>
                <li className="list-group-item">
                  <a href="#">
                    <i className="fa fa-tasks"/> Recent Activity <span className="badge badge-danger pull-right">15</span>
                  </a>
                </li>
                <li className="list-group-item">
                  <a href="#">
                    <i className="fa fa-bell-o"/> Notification <span className="badge badge-success pull-right">11</span>
                  </a>
                </li>
                <li className="list-group-item">
                  <a href="#">
                    <i className="fa fa-comments-o"/> Message <span className="badge badge-warning pull-right r-activity">03</span>
                  </a>
                </li>
              </ul>
          ...
          <div className="feed-box text-center">
            <section className="card">
              <div className="card-body">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere, laudantium explicabo autem molestias
                  eaque, mollitia impedit, officia repudiandae culpa nemo veritatis quisquam totam error voluptate vel,
                  quod nihil nobis tempora.
                </p>
              </div>
            </section>
          </div>
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-header">
              <strong className="card-title">Card with Label <small><span
                className="badge badge-success float-right mt-1">Success</span></small></strong>
            </div>
            <div className="card-body">
              <p className="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-header">
              <strong className="card-title">Card with Label <small><span
                className="badge badge-danger float-right mt-1">49</span></small></strong>
            </div>
            <div className="card-body">
              <p className="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>
          ...
          <div className="card bg-warning">
            <div className="card-body">
              <blockquote className="blockquote mb-0 text-light">
                <p className="text-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat
                  a ante.</p>
        ...
        <div className="col-md-4">
          <div className="card">
            ...
            <div className="card-body text-white bg-primary">
              <p className="card-text text-light">Some quick example text to build on the card title and make up the
        ...
        <div className="col-md-4">
          <div className="card">
            <img className="card-img-top" src="https://i.imgur.com/ue0AB6J.png" alt="Card image cap"/>
            <div className="card-body">
        ...
        <div className="col-md-4">
          <div className="card">
            <img className="card-img-top" src="https://i.imgur.com/hrS2McC.png" alt="Card image cap"/>
            <div className="card-body">
              <h4 className="card-title mb-3">Card Image Title</h4>
              <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
        ...
        <div className="col-md-4">
          <div className="card">
            <img className="card-img-top" src="https://i.imgur.com/MUBS4Gh.png" alt="Card image cap"/>
            <div className="card-body">
              <h4 className="card-title mb-3">Card Image Title</h4>
              <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
