              ...
              <div className="card-body">
                ...
                <div className="typo-articles">
                  <p>
                    ...
                    variety of habitats, such as grasslands, savannas,
                    ...
                    populations, in particular hunting for skins and habitat destruction. Grévy's zebra and the
                    mountain <mark>highlighted text</mark> zebra are endangered.
                  </p>
                  <blockquote className="blockquote mt-3 text-right">
                    <p>
                      Blockquotes. However, various anthropogenic factors have had a severe impact on zebra populations,
                      in particular hunting for skins. </p>
                  ...
                  <p>
                    ...
                    zebras have been crossed with mountain zebras. The hybrid foals <span
                    className="bg-flat-color-1 text-light">selected text</span> lacked a dewlap and resembled their
                  </p>
                </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="jumbotron">
                        Zebras have excellent eyesight. It is believed that they can see in color. Like most ungulates,
                        the zebra's eyes are on the sides of its head, giving it a wide field of view.
                      </div>
                    </div>
                  </div>
                </div>
